...
class PersistentFieldState:
    """Immutable persistence representation of durable field values.
    ...
    @classmethod
    def empty(cls) -> Self:
        """Create an empty persistent field state."""
        return cls({})
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, PersistentFieldState):
            return NotImplemented

        return self._values == other._values

    def __repr__(self) -> str:
        return f"PersistentFieldState({dict(self._values)!r})"
